...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            closest_player_id_to_ball = min(player_bbox.keys(), key=lambda x: measure_distance(ball_position, get_center_of_box(player_bbox[x])))
            ...
            for player_id, bbox in player_bbox.items():
                ...
                bboxes_heights_in_pixels = [get_height_of_box(player_boxes[i][player_id]) for i in range (frame_index_min,frame_index_max)]
